...
def test_audio_export_naming_prefers_ascii_safe_export_identity_when_provided() -> None:
    ...
    assert build_audio_track_file_name('伟大的2', track_number=1, track_id='MediaRow1SideA1_ABC123') == 'MediaRow1SideA1_ABC123.ogg'
...
def test_export_plan_uses_stable_ascii_safe_audio_paths_for_non_ascii_labels() -> None:
    ...
    assert track.export_relative_path.replace('\\', '/') == f'{row_plan.export_id}/A-Side/{track.track_id}.ogg'
