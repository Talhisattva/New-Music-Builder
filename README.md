![New Music Builder](docs/images/NewMusicBuilder0.2.8-640-transparent.png)
...
This is a small patch release in the `0.2.x` line focused on safer `.ogg` re-encoding, export stability, and release polish for the current Tali's New Music workflow.
