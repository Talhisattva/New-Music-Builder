![New Music Builder](docs/images/NewMusicBuilder0.2.7-640-transparent.png)
...
This is a small patch release in the `0.2.x` line focused on export cleanup, release polish, and safer runtime-facing output for the current Tali's New Music workflow.
