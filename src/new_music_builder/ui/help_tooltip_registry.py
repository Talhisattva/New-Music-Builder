...
HELP_TOOLTIP_REGISTRY: dict[str, tuple[TooltipSegment, ...]] = {
    ...
    'menu.preferences.audio_settings': (
        TooltipSegment('Adjust export sample rate, compression quality, and existing OGG re-encode behavior.'),
    ),
    'menu.preferences.automatic_textures': (
        TooltipSegment('Automatically generate supported textures from selected cover art when available.'),
    ),
}
